...
public class HttpsIotHubConnectionTest
{
    ...
    public void sendEventSetsIotHubSSLContext(@Mocked final IotHubEventUri mockUri,
                                              @Mocked final SSLContext mockContext) throws SecurityProviderException, TransportException
    {
        new NonStrictExpectations()
        {
            {
    ...
    public void sendMessageResultSetsIotHubSSLContext(@Mocked final IotHubRejectUri mockUri,
                                                      @Mocked final SSLContext mockedContext, final @Mocked IotHubStatusCode mockStatusCode) throws SecurityProviderException, TransportException
    {
        final String eTag = "test-etag";
        final int readTimeoutMillis = 23;
        new NonStrictExpectations()
    ...
    @Test
    public void sendEventPullsSSLContextFromAppropriateConfigAuthObject() throws SecurityProviderException, TransportException
    {
        //arrange
        HttpsIotHubConnection conn = new HttpsIotHubConnection(mockConfig);
        conn.setListener(mockedListener);
    ...
    @Test
    public void sendHttpsMessagePullsSSLContextFromAppropriateConfigAuthObject() throws SecurityProviderException, TransportException
    {
        //arrange
        HttpsIotHubConnection conn = new HttpsIotHubConnection(mockConfig);
        final String uriPath = "/files";
    ...
    @Test
    public void receiveMessagePullsSSLContextFromAppropriateConfigAuthObject() throws SecurityProviderException, TransportException
    {
        //arrange
        HttpsIotHubConnection conn = new HttpsIotHubConnection(mockConfig);
        new NonStrictExpectations()
    ...
    @Test
    public void sendMessageResultPullsSSLContextFromAppropriateConfigAuthObject(final @Mocked IotHubStatusCode mockStatusCode) throws SecurityProviderException, TransportException
    {
        //arrange
        final String eTag = "test-etag";
        new NonStrictExpectations()
