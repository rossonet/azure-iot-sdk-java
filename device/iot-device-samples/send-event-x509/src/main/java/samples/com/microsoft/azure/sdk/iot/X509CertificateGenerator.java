...
public class X509CertificateGenerator
{
     ...
     */
    public static GeneratedCert generateCertificateWithReturn(String commonName, GeneratedCert issuer) throws OperatorCreationException, CertificateException, InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException, SignatureException, CertIOException, InvalidAlgorithmParameterException {
...
final class GeneratedCert {
    public final PrivateKey privateKey;
    public final X509Certificate certificate;
    public final String x509ThumbPrint;

    public GeneratedCert(PrivateKey privateKey, X509Certificate certificate) throws CertificateEncodingException {
        this.privateKey = privateKey;
        this.certificate = certificate;
        this.x509ThumbPrint = new String(Hex.encodeHex(DigestUtils.sha(certificate.getEncoded())));
    }
}
